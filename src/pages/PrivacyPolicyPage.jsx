        ...
        <Container>
          <div className="legal-document-shell max-w-4xl mx-auto">
            ...
            <div className="legal-text-block">
              ...
              <h3>6. Your Rights</h3>
              <p>
                You have the right to access, correct, or request the deletion of your personal information. If you wish to opt-out of future communications or have questions about your data, please contact us at <strong>info@patelfoundation.in</strong>.
              </p>
              ...
              <p>
                ...
                Email: info@patelfoundation.in<br />
