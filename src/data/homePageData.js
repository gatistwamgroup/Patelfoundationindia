export const whoWeAreData = {
  badge: "Who We Are",
  title: "A compassionate foundation dedicated to lasting community change.",
  ...
  points: [
    ...
    "Designed to support children, families, and underserved communities",
  ],
  primaryBtn: {
    text: "Learn About Us",
    href: "/about",
...
export const dailyImpactData = [
  { value: "500+", label: "Children Supported", color: "primary" },
  { value: "120+", label: "Education Kits Distributed", color: "gold" },
  { value: "35+", label: "Community Drives Conducted", color: "teal" },
  { value: "50+", label: "Dedicated Volunteers", color: "dark" },
];
...
export const trustData = [
  {
    ...
    description:
      "We focus on measurable outcomes and clear communication that builds donor confidence and long-term trust.",
  },
  {
    id: 2,
    title: "Community-Led Approach",
    description:
      "Our initiatives are shaped by real needs, local support, and compassionate collaboration with people on the ground.",
  },
  {
    id: 3,
    title: "Purpose-Driven Programs",
    description:
      "Every program is designed to deliver meaningful change with dignity, empathy, and sustainable long-term value.",
  },
];
